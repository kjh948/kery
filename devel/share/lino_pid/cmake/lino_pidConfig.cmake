...
if("TRUE" STREQUAL "TRUE")
  set(lino_pid_SOURCE_PREFIX /home/atomicpi/workspace/kery/src/lino_pid)
  set(lino_pid_DEVEL_PREFIX /home/atomicpi/workspace/kery/devel)
  set(lino_pid_INSTALL_PREFIX "")
  set(lino_pid_PREFIX ${lino_pid_DEVEL_PREFIX})
else()
  set(lino_pid_SOURCE_PREFIX "")
  set(lino_pid_DEVEL_PREFIX "")
  set(lino_pid_INSTALL_PREFIX /home/atomicpi/workspace/kery/install)
...
if(NOT "/home/atomicpi/workspace/kery/devel/include;/home/atomicpi/workspace/kery/src/lino_pid/include " STREQUAL " ")
  set(lino_pid_INCLUDE_DIRS "")
  set(_include_dirs "/home/atomicpi/workspace/kery/devel/include;/home/atomicpi/workspace/kery/src/lino_pid/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lino_pid' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/atomicpi/workspace/kery/src/lino_pid/${idir}'.  ${_report}")
    endif()
