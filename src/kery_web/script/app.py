...
try:
   ...
   import Queue as queue # for serial command queue
...
loginPassword = "p"                                  # Password for web-interface
arduinoPort = "ARDUINO"                                              # Default port which will be selected
streamScript = "../run_mjpg_streamer.sh"                           # Location of script used to start/stop video stream
